...
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            ...
            <router-link to="/monitored-tags" class="btn btn-muted d-flex align-items-center py-2 mr-3" title="Monitoring">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon" fill="currentColor">
            ...
            <a href="{{ route('cockpit.dashboard') }}" class="btn btn-outline-primary d-flex align-items-center py-2 px-3 font-weight-bold" title="Kembali ke Cockpit">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="icon mr-1" style="width: 1.1rem; height: 1.1rem;">
                    <path fill-rule="evenodd" d="M17 10a.75.75 0 01-.75.75H5.612l4.158 3.96a.75.75 0 11-1.04 1.08l-5.5-5.25a.75.75 0 010-1.08l5.5-5.25a.75.75 0 111.04 1.08L5.612 9.25H16.25A.75.75 0 0117 10z" clip-rule="evenodd" />
                </svg>
                <span>Kembali ke Cockpit</span>
            </a>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-2 sidebar">
                <ul class="nav flex-column">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\CommandWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\ScheduleWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\JobWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\BatchWatcher::class))
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\CacheWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\DumpWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\EventWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\ExceptionWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\GateWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\ClientRequestWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\LogWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\MailWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\ModelWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\NotificationWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\QueryWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\RedisWatcher::class))
                    <li class="nav-item">
                    ...
                    @if (\Laravel\Telescope\Telescope::hasWatcher(\Laravel\Telescope\Watchers\ViewWatcher::class))
                    <li class="nav-item">
