        ...
        >
            <div
                ...
                :class="[
                    ...
                    'absolute top-full mt-1.5 z-50 min-w-[200px] max-w-[280px] rounded-xl bg-white p-1.5 shadow-xl ring-1 ring-black/5 focus:outline-none border border-gray-200 text-xs sm:text-sm space-y-1',
                ]"
            >
