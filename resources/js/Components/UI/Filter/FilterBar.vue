<template>
    ...
    >
        ...
        <!-- Right / Actions & Search Area (Desktop: Right shrink-0, Mobile: Top row) -->
        <div
            class="order-1 md:order-2 flex items-center gap-1.5 md:gap-2 justify-between md:justify-end shrink-0 w-full md:w-auto"
        >
            <!-- Search slot (Fills width on mobile, standard width on desktop) -->
            ...
            <!-- Actions & Right slots -->
            <div
                v-if="$slots.actions || $slots.right"
