<template>
    <aside class="modal !justify-end pt-4 overscroll-contain" :class="{ show: show }">
        <div class="modal-dialog side h-[100%]" :class="[sizeClasses[size] || size]">
            <div class="modal-content h-full flex flex-col">
                <!-- Modal Header -->
                <div class="modal-header border-b-0 shrink-0 sticky top-0 p-5 pb-2 bg-white z-10">
                    <div class="font-bold">
                        <span class="text-xl">
                            {{ title }}
                            <span
