    ...
    <div class="w-full">
      ...
      >
        ...
        <div
          ...
          :class="isOpen ? 'max-h-60 opacity-100 scale-y-100' : 'max-h-0 opacity-0 scale-y-95'"
        >
          <div class="text-sm max-h-60 overflow-y-auto floating-scroll">
            <ol class="">
              <li>
                <div :ref="(el) => { if (!selectedOutlet) activeItemRef = el }">
                    <Link
                    method="post"
                    ...
                    :class="{
                        'bg-neutral-light font-medium text-main': !selectedOutlet,
              ...
              <li v-for="(o, index) in outlets" :key="index">
                <div :ref="(el) => { if (o.id === selectedOutlet?.id) activeItemRef = el }">
                    <Link
                    method="post"
                    :preserve-scroll="true"
                    :preserve-state="true"
                    ...
                    :class="{
                        ...
                        'text-neutral-600': o.id !== selectedOutlet?.id
                    }"
                    @click="selectOutlet"
                    >
                    {{ o.name }}
