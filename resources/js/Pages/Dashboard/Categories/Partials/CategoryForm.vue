...
<template>
    <form @submit.prevent="emit('submit')" class="space-y-6">
        <div>
            ...
            <div class="mt-1">
                <input type="text" v-model="form.name" id="name" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
        ...
        <div>
            ...
            <div class="mt-1">
                <select v-model="form.parent_id" id="parent_id" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        ...
        <div class="flex items-center justify-end space-x-4">
            <Link :href="route('categories.index')" class="text-sm text-gray-600 hover:text-gray-900">Batal</Link>
