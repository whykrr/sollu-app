    ...
    <div class="flex flex-col border rounded-lg bg-white p-2 h-full gap-4">
      <div class="inline-flex justify-between">
        <div class="text-lg font-medium">
          ...
          <div class="text-sm">
            ...
            <div>
              Metode Pembayaran :
              <span v-if="payment && payment.payment_method">{{ payment.payment_type.toUpperCase() }} -
                {{
        ...
        <div class="mt-2">
          ...
          >Dibatalkan</label>
          <label v-else class="badge text-xl badge-gray-400">Expired</label>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="border gap-2 p-2 rounded-lg">
          ...
          <div class="text-sm">
            {{ invoice.merchant.name }} <br />
            {{ invoice.merchant.owner_name }} <br />
      ...
      <div class="flex justify-between gap-2">
        <div>
          <Link
            ...
            method="DELETE"
            :href="
              route('dashboard.merchant.invoices.cancel', {
                code: invoice.code,
              })
            "
