<template>
    <div class="flex flex-wrap items-center gap-2">
        ...
        <div class="flex-1 flex flex-wrap items-center gap-1.5">
            ...
            <div v-if="filterForm.reason !== ''" class="filter-badge">
                <span>Alasan: {{ getReasonName(filterForm.reason) }}</span>
                <button
                    type="button"
                    @click="removeFilter('reason')"
                    class="filter-badge-remove"
                    title="Hapus filter"
                >
                    ✕
        ...
        <div v-if="showFilterModal" class="overlay-backdrop">
            <div class="overlay-modal max-w-md">
                ...
                <div class="overlay-header">
                    <h3 class="overlay-title">Filter Penyesuaian Stok</h3>
                    <button
                        type="button"
                        @click="closeModal"
                        class="overlay-close"
