    ...
    >
        <div class="flex flex-col h-full">
            ...
            <div class="flex items-center justify-center mb-6">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 font-medium" :class="step >= 1 ? 'text-slate-800' : 'text-slate-400'">Informasi</span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 font-medium" :class="step >= 2 ? 'text-slate-800' : 'text-slate-400'">Konfirmasi</span>
                    </div>
                </div>
            </div>
            ...
            <div v-if="step === 1" class="flex-1">
                <div class="mb-4">
                    <p class="text-sm text-slate-500">Lengkapi informasi dasar mengenai outlet baru Anda.</p>
                </div>
            ...
            <div v-if="step === 2" class="flex-1">
                <div class="mb-4">
                    <p class="text-sm text-slate-500">Mohon periksa kembali informasi outlet sebelum menyimpan.</p>
                </div>
                <div class="bg-slate-50 rounded-xl p-4 border border-slate-100 mb-4">
                    <div class="mb-3">
                        <span class="text-xs text-slate-400 uppercase tracking-wider font-semibold">Nama Outlet</span>
                        <p class="font-medium text-slate-800 mt-1">{{ formOutlet.name || '-' }}</p>
                    </div>
                    <div>
                        <span class="text-xs text-slate-400 uppercase tracking-wider font-semibold">Alamat</span>
