<template>
    <MainPage>
        <template #header>
            <MainPageHeader :title="`Faktur ${invoice.receipt_number}`" />
        ...
        <div
            class="p-6 bg-white max-w-4xl mx-auto rounded-lg shadow-sm border border-gray-100 my-4"
            id="printable-invoice"
        >
            <!-- Header Invoice -->
            <div
                class="flex justify-between items-start border-b border-gray-200 pb-6 mb-6"
            >
                <div>
                    <h2 class="text-3xl font-bold text-gray-800">INVOICE</h2>
                    <p class="text-gray-500 mt-1">
                        Nomor: {{ invoice.receipt_number }}
                    </p>
                    <p class="text-gray-500">
                        Tanggal: {{ formatDateTimeSimple(invoice.created_at) }}
                    </p>
                    <p class="text-gray-500">
                        Jatuh Tempo:
                        {{
                            invoice.due_date
                                ? formatDateTimeSimple(invoice.due_date)
                                : '-'
                        }}
                    </p>
                </div>
            ...
            <table class="w-full text-left mb-8">
                <thead>
                    <tr
                        class="bg-gray-50 text-gray-600 border-y border-gray-200"
                    >
            ...
            <div class="flex justify-end">
                <div class="w-full md:w-1/2 space-y-3 text-gray-600">
                    ...
                    <div
                        class="flex justify-between"
                        v-if="Number(invoice.service_charge_amount) > 0"
                    >
                    ...
                    <div
                        class="pt-4 border-t border-gray-200 flex justify-between items-center text-lg"
                    >
