        ...
        <Container>
                ...
                <div class="flex flex-row justify-between gap-2">
                    ...
                    <div class="flex gap-2">
                        <button class="btn btn-outline-main">
                            <FontAwesomeIcon :icon="faDownload" class="mr-2" /> Export Report
                        </button>
                    </div>
                </div>
            </template>
            ...
            >
                ...
                <template #actions="{ row }">
                    <Link :href="route().has('cockpit.subscriptions.show') ? route('cockpit.subscriptions.show', 1) : '#'" class="btn btn-neutral-100 text-neutral-600 btn-sm" title="Manage">
...
const tableHeaders = [
    ...
    { field: 'merchant', label: 'Merchant Name', slot: 'merchant', sortable: true },
    { field: 'plan', label: 'Plan', slot: 'plan' },
    { field: 'status', label: 'Status', slot: 'status' },
    { field: 'expires_at', label: 'Expires At', slot: 'expires_at', sortable: true },
];

const subscriptions = ref({
    data: [
        { id: '#SUB-001', merchant: 'Toko Sejahtera', plan: 'Premium (Yearly)', status: 'Expiring Soon', expires_at: '12 Jan 2027' },
        { id: '#SUB-002', merchant: 'Kedai Kopi Senja', plan: 'Basic (Monthly)', status: 'Active', expires_at: '25 Feb 2027' },
    ],
    links: [
