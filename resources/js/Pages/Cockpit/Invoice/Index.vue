        ...
        <Container>
            ...
            >
                ...
                <template #actions="{ row }">
                    <button class="btn btn-neutral-100 text-neutral-600 btn-sm" title="View Proof">
                        <FontAwesomeIcon :icon="faEye" />
                    </button>
                    <button v-if="row.status === 'Pending Review'" class="btn btn-success/10 text-success btn-sm" title="Approve">
                        <FontAwesomeIcon :icon="faCheck" />
                    </button>
                    <button v-if="row.status === 'Pending Review'" class="btn btn-danger/10 text-danger btn-sm" title="Reject">
...
const tableHeaders = [
    ...
    { field: 'invoice_id', label: 'Invoice ID', slot: 'invoice_id', sortable: true },
...
const invoices = ref({
    data: [
        { id: 1, date: '14 Jun 2026 14:30', invoice_id: 'INV-2026-892', merchant: 'Toko Sejahtera', amount: 'Rp 4.500.000', status: 'Pending Review' },
        { id: 2, date: '13 Jun 2026 09:15', invoice_id: 'INV-2026-891', merchant: 'Warung Makan Bahari', amount: 'Rp 1.200.000', status: 'Pending Review' },
    ],
    links: [
