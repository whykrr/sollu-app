    ...
    <div>
        ...
        <form v-else class="space-y-2" @submit.prevent="submit">
            ...
            <div class="bg-white border border-slate-200 rounded-lg p-3 space-y-2">
                ...
                >
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-0.5">
                            Personalisasi hak akses modul dan kapabilitas sistem bawaan yang aktif
                            untuk jenis bisnis ini.
                        </p>
                    </div>
                    <div class="flex items-center gap-2">
                        <span
                            class="px-2.5 py-1 bg-main/10 text-main font-bold text-xs rounded-full"
                        >
                ...
                <div
                    class="pt-2 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-2"
                >
                ...
                >
                    ...
                    <div class="p-2.5 grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <label
                            ...
                            :key="feat.code"
                            class="flex items-start gap-2 p-2 rounded-lg border transition-all cursor-pointer select-none"
                            :class="
                        ...
                        >
                            <input
                                ...
                                type="checkbox"
                                :value="feat.code"
                                class="mt-0.5 rounded border-slate-300 text-main focus:ring-main h-4 w-4 shrink-0 cursor-pointer"
                            />
...
import GroupTextIconField from '@/Components/Form/GroupTextIconField.vue'
