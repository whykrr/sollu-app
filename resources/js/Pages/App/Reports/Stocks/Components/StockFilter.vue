...
const applyFilters = () => {
    ...
    router.get(route('reports.stocks.index'), params, {
        preserveState: true,
        preserveScroll: true,
    })
}
...
const exportPdf = () => {
    router.post(route('reports.stocks.export.pdf'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
...
const exportCsv = () => {
    router.post(route('reports.stocks.export.csv'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
