...
const applyFilters = () => {
    ...
    router.get(route('reports.cashiers.index'), params, {
        preserveState: true,
        preserveScroll: true,
    })
}
...
const exportPdf = () => {
    router.post(route('reports.cashiers.export.pdf'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
...
const exportCsv = () => {
    router.post(route('reports.cashiers.export.csv'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
