...
const applyFilters = () => {
    ...
    router.get(route('reports.products.index'), params, {
        preserveState: true,
        preserveScroll: true,
    })
}
...
const exportPdf = () => {
    router.post(route('reports.products.export.pdf'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
...
const exportCsv = () => {
    router.post(route('reports.products.export.csv'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
