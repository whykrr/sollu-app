...
const tabOptions = [
    { value: 'daily', label: 'Penjualan Harian' },
    { value: 'payment', label: 'Metode Pembayaran' },
]
...
const applyFilters = () => {
    ...
    router.get(route('reports.sales.index'), params, {
        preserveState: true,
        preserveScroll: true,
    })
}
...
const exportPdf = () => {
    router.post(route('reports.sales.export.pdf'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
...
const exportCsv = () => {
    router.post(route('reports.sales.export.csv'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
