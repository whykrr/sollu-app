...
const applyFilters = () => {
    ...
    router.get(route('reports.promotions.index'), params, {
        preserveState: true,
        preserveScroll: true,
    })
}
...
const exportPdf = () => {
    router.post(route('reports.promotions.export.pdf'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
...
const exportCsv = () => {
    router.post(route('reports.promotions.export.csv'), formFilters.value, {
        preserveScroll: true,
        preserveState: true,
    })
}
