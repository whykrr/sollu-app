    ...
    <div class="space-y-4">
        ...
        >
            <div class="flex flex-col items-center gap-2">
                ...
                <div
                    class="rounded-full bg-slate-100 px-3 py-1 text-[10px] font-semibold text-slate-500"
                >
        ...
        <div v-else class="space-y-2">
            <div
                class="text-[11px] text-slate-500 font-medium mb-2 bg-slate-50 p-2.5 rounded-lg border border-slate-100"
            >
                💡 <strong>Informasi:</strong> Foto urutan pertama (<strong>#1</strong>) akan
                digunakan sebagai foto utama / cover produk di aplikasi POS dan e-commerce. Gunakan
            ...
            <div class="grid grid-cols-3 sm:grid-cols-4 gap-2">
                ...
                >
                    ...
                    <!-- Overlay Actions -->
                    <div
                        class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity z-10 flex flex-col justify-between p-2"
                    >
                        <!-- Top Actions: Delete -->
                        ...
                        <div class="flex justify-between items-center text-white text-xs z-20">
                            ...
                            <span class="font-bold bg-black/40 px-2 py-0.5 rounded-full text-[10px]"
                                >#{{ idx + 1 }}</span
                            >
                            <button
                                type="button"
