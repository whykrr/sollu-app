            ...
            <div class="lg:col-span-8 flex flex-col gap-4">
                ...
                >
                    <div class="flex items-start gap-3.5">
                        <div
                            ...
                            :class="
                                form.costing_method === 'fifo' ? 'bg-emerald-600' : 'bg-indigo-600'
                            "
                        >
                            <FontAwesomeIcon
                                :icon="
                                    form.costing_method === 'fifo' ? faBoxesStacked : faCalculator
                                "
                                class="text-lg"
                            />
                        </div>
                        ...
                        >
                            <div class="space-y-2.5">
                                <div class="flex items-center justify-between gap-2">
                                    ...
                                    >
                                        <FontAwesomeIcon
                                            v-if="form.costing_method === 'average'"
                                            :icon="faCheck"
                                            class="text-[10px]"
                                        />
                                    </div>
                ...
                >
                    ...
                    >
                        ...
                        <span>{{
                            form.processing ? 'Menyimpan...' : 'Simpan Perubahan Metode'
                        }}</span>
                    </button>
                </div>
            </div>
