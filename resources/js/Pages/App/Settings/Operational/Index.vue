                ...
                >
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-0.5">
                            Atur jam buka dan tutup untuk outlet
                            <strong>{{ selectedOutlet?.name }}</strong> (Zona Waktu:
                            {{ selectedOutlet?.timezone || 'WIB' }}).
                        </p>
                    </div>
                    <button
                        type="button"
                        ...
                        <div class="flex items-center gap-4 flex-1">
                            <div class="flex items-center gap-2">
                                ...
                                <span
                                    ...
                                    :class="day.is_closed ? 'text-rose-500' : 'text-emerald-600'"
                                >
