        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 pb-12">
                        ...
                        >
                            <div>
                                ...
                                <div class="text-xs text-slate-500">
                                    Pajak dihitung secara inklusif ke dalam harga barang
                                </div>
                            </div>
                            <Switch
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            <div>
                                ...
                                <div class="text-xs text-slate-500">
                                    Membulatkan total tagihan akhir ke kelipatan ratusan rupiah
                                </div>
                            </div>
                            <Switch
                                id="rounding_enabled"
            ...
            <div class="lg:col-span-5">
                ...
                >
                    ...
                    <div class="space-y-3 text-xs">
                        ...
                        <div class="flex justify-between py-1.5 text-slate-600">
                            ...
                            <span class="font-medium text-slate-900"
                                >+ Rp {{ formatNumber(calculatedService) }}</span
                            >
                        </div>
                        ...
                        <div class="flex justify-between py-1.5 text-slate-600">
                            ...
                            <span class="font-medium text-slate-900"
                                >+ Rp {{ formatNumber(calculatedTax) }}</span
                            >
                        </div>

                        <div
                            v-if="form.rounding_enabled"
                            class="flex justify-between py-1.5 text-slate-600"
                        >
                            <span>Penyesuaian Pembulatan:</span>
                            <span class="font-medium text-slate-900"
                                >Rp {{ formatNumber(calculatedRounding) }}</span
                            >
                        </div>

                        <div
                            class="flex justify-between py-3 border-t border-slate-200 font-bold text-sm text-slate-900 bg-slate-50 -mx-5 px-5 mt-2"
                        >
                    ...
                    >
                        <strong>Keterangan:</strong> Pajak dan biaya layanan ini akan otomatis
                        diterapkan ke setiap transaksi yang dilakukan pada outlet
...
import { faCalculator, faCoins, faPercent, faSave } from '@fortawesome/free-solid-svg-icons'
