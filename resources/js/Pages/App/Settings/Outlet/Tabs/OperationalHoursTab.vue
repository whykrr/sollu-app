    ...
    <div class="flex flex-col gap-4 p-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mb-4">
                Atur jadwal operasional outlet ini setiap harinya.
            </p>
        </div>
        ...
        <div class="space-y-2">
            ...
            >
                <div
                    class="w-24 md:w-32 font-medium"
                    :class="day.is_closed ? 'text-slate-400' : 'text-slate-700'"
                >
                ...
                <div class="w-20 md:w-24">
                    <Switch
                        ...
                        size="sm"
                        :labeling="day.is_closed ? 'Tutup' : 'Buka'"
                    />
                </div>
