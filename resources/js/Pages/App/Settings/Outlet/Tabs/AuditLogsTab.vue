    ...
    <div class="flex flex-col gap-4 p-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mb-4">
                Riwayat perubahan dan aktivitas pada outlet ini (50 aktivitas terakhir).
            </p>
        </div>

        <div
            v-if="!outlet?.audit_logs || outlet.audit_logs.length === 0"
        ...
        <div v-else class="relative pl-4 border-l-2 border-slate-200 space-y-6 mt-4">
            <div v-for="log in outlet.audit_logs" :key="log.id" class="relative">
                ...
                <div class="bg-white border rounded-lg p-4 shadow-sm ml-2">
                    ...
                    <div
                        v-if="log.metadata"
                        class="text-xs bg-slate-50 p-2 rounded border font-mono text-slate-600 overflow-x-auto"
                    >
