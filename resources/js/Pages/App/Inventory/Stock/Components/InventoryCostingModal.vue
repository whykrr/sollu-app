    ...
    <div class="space-y-4 text-left">
        ...
        <div class="rounded-xl border border-sky-100 bg-sky-50/60 p-3.5 sm:p-4">
            <div class="flex items-start gap-3">
                <div
                    class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-sky-500 text-white shadow-xs"
                >
                    ...
                    <h4 class="text-sm font-semibold text-slate-800">
                        {{
                            isSetupMode
                                ...
                                : 'Pilih Metode Perhitungan Aset Inventaris'
                        }}
                    </h4>
                    <p class="text-xs leading-relaxed text-slate-600">
                        Metode ini menentukan cara sistem menghitung harga pokok penjualan (HPP)
                        barang keluar dan menghitung nilai rupiah sisa persediaan di tokomu.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            >
                <div class="space-y-2.5">
                    ...
                    <div>
                        <div class="text-sm font-bold text-slate-800 flex items-center gap-1.5">
                            ...
                            <span class="text-xs font-normal text-slate-500"
                                >(First-In, First-Out)</span
                            >
                        </div>
                        <p class="text-xs text-slate-500 mt-0.5">Masuk pertama, keluar pertama</p>
                    </div>

                    <!-- Explanation -->
                    <p class="text-xs leading-relaxed text-slate-600">
                        Stok yang dibeli
                        <strong class="font-semibold text-slate-700">lebih dulu</strong> akan
                        dicatat keluar lebih dulu. Nilai aset persediaan di gudang selalu mengikuti
                        harga beli terbaru.
                    </p>
                    ...
                    >
                        ...
                        <p class="leading-normal text-slate-500">
                            Beli 10 kg @Rp25rb, lalu 10 kg @Rp28rb. Saat pakai 5 kg, sistem memotong
                            HPP batch awal yaitu <strong class="text-slate-700">Rp25rb/kg</strong>.
                        </p>
                    </div>
                </div>
                ...
                <div
                    class="mt-3 pt-2.5 border-t border-slate-100 flex items-center gap-1 text-[11px] text-slate-500"
                >
            ...
            >
                <div class="space-y-2.5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-0.5">Rata-rata bergerak otomatis</p>
                    </div>

                    <!-- Explanation -->
                    <p class="text-xs leading-relaxed text-slate-600">
                        Harga modal dihitung dari
                        <strong class="font-semibold text-slate-700">rata-rata tertimbang</strong>
                        setiap kali ada stok masuk baru. Menghasilkan HPP yang stabil dan merata.
                    </p>
                    ...
                    >
                        ...
                        <p class="leading-normal text-slate-500">
                            Punya 10 pcs @Rp50rb, beli lagi 10 pcs @Rp60rb. HPP seluruh stok
                            otomatis menjadi <strong class="text-slate-700">Rp55rb/pcs</strong>.
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    <span
                        >Sangat cocok untuk fashion, aksesoris, ATK, elektronik, & retail
                        umum.</span
                    >
                </div>
            </div>
        ...
        >
            ...
            <div class="space-y-0.5">
                ...
                <p class="text-[11px] leading-relaxed text-amber-700">
                    Sistem Sollu otomatis menyinkronkan data secara ganda di latar belakang. Kamu
                    dapat mengganti metode ini kapan saja di menu Pengaturan tanpa merusak transaksi
                    yang sudah berjalan.
                </p>
            </div>
        </div>
