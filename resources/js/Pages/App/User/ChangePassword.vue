<template>
    <CardTransparent :title="$t('link.changePassword')">
        <form class="grid grid-cols-2 gap-x-4 gap-y-2 mb-0" @submit.prevent="submitData">
            <div>
                ...
                />
                <span class="form-feedback">{{ form.errors.old_password }}</span>
            </div>
            <div>
            ...
            <div>
                <label for="password_confirmation">{{ $t('field.passwordConfirmation') }}</label>
                <input
