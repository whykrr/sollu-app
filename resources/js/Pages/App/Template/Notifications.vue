    ...
    <MainPage>
        <div class="flex flex-col gap-4">
            ...
            <Card title="Toast Notifications (Generic & Stackable)">
                <div class="flex flex-col gap-4">
                    <p class="text-sm text-slate-600">
                        Toast notifications now support global state management (<code
                            class="text-xs bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200"
                            >useToastStore()</code
                        >), stacked display, custom actions, and styled cards matching modern design
                        standards.
                    </p>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <button class="btn btn-outline-main" @click="triggerStackedToasts">
            ...
            <Card title="Generic Modal Dialog (useModalStore)">
                <div class="flex flex-col gap-4">
                    <p class="text-sm text-slate-600">
                        Modal dialogs can now be triggered from any component globally using
                        <code
                            class="text-xs bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200"
                            >useModalStore()</code
                        >.
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <button class="btn btn-main" @click="triggerConfirmModal">
                        ...
                        <button class="btn btn-outline-main" @click="triggerAlertModal">
                            Trigger Alert Modal
                        </button>
                    ...
                    >
                        <p class="text-slate-600 text-sm">
                            Ini adalah contoh penggunaan komponen
                            <code class="text-xs bg-slate-100 px-1 py-0.5 rounded"
                                >&lt;Modal :show="..." /&gt;</code
                            >
                            secara langsung di dalam template komponen.
                        </p>
                        <template #footer>
                            <button class="btn btn-main" @click="showInlineModal = false">
                                Tutup
                            </button>
                        </template>
                    </Modal>
