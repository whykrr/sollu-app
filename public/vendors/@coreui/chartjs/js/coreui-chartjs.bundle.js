...
(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        ? define(factory)
        : ((global = global || self),
          ((global.coreui = global.coreui || {}),
          (global.coreui.ChartJS = factory())));
})(this, function () {
    "use strict";
    ...
    (function (global, factory) {
        ...
        moment =
            moment && moment.hasOwnProperty("default")
                ? moment["default"]
                : moment;
	...
	*/
        ...
        Color.prototype = {
            ...
            rgbString: function () {
                return colorString.rgbString(
                    this.values.rgb,
                    this.values.alpha
                );
            },
            rgbaString: function () {
                return colorString.rgbaString(
                    this.values.rgb,
                    this.values.alpha
                );
            },
            ...
            hslString: function () {
                return colorString.hslString(
                    this.values.hsl,
                    this.values.alpha
                );
            },
            hslaString: function () {
                return colorString.hslaString(
                    this.values.hsl,
                    this.values.alpha
                );
            },
            hwbString: function () {
                return colorString.hwbString(
                    this.values.hwb,
                    this.values.alpha
                );
            },
        ...
        Color.prototype.setValues = function (space, vals) {
            ...
            for (i = 0; i < space.length; i++) {
                capped = Math.max(
                    0,
                    Math.min(maxes[space][i], values[space][i])
                );
        ...
        helpers$1.extend(DatasetController.prototype, {
            ...
            _resolveDatasetElementOptions: function (element, hover) {
                ...
                var options =
                    chart.options.elements[
                        me.datasetElementType.prototype._type
                    ] || {};
            ...
            _resolveDataElementOptions: function (element, index) {
                ...
                var options =
                    chart.options.elements[
                        me.dataElementType.prototype._type
                    ] || {};
            ...
            _setDatasetHoverStyle: function () {
                ...
                hoverOptions = this._resolveDatasetElementOptions(
                    element,
                    true
                );
        ...
        var element_arc = core_element.extend({
            ...
            inRange: function (chartX, chartY) {
                ...
                if (vm) {
                    var pointRelativePosition = helpers$1.getAngleFromPoint(
                        vm,
                        { x: chartX, y: chartY }
                    );
        ...
        var element_line = core_element.extend({
            ...
            draw: function () {
                ...
                ctx.lineCap =
                    vm.borderCapStyle ||
                    globalOptionLineElements.borderCapStyle;
        ...
        function computeFlexCategoryTraits(index, ruler, options) {
            ...
            if (prev === null) {
                ...
                prev =
                    curr -
                    (next === null ? ruler.end - ruler.start : next - curr);
            }
        ...
        var controller_bar = core_datasetController.extend({
            ...
            initialize: function () {
                ...
                core_datasetController.prototype.initialize.apply(
                    me,
                    arguments
                );
            ...
            _updateElementGeometry: function (
                ...
                var vpixels = me.calculateBarValuePixels(
                    me.index,
                    index,
                    options
                );
        ...
        var controller_doughnut = core_datasetController.extend({
            ...
            update: function (reset) {
                ...
                for (i = 0, ilen = arcs.length; i < ilen; ++i) {
                    arcs[i]._options = me._resolveDataElementOptions(
                        arcs[i],
                        i
                    );
                }
                ...
                maxWidth =
                    (chartArea.right - chartArea.left - chart.borderWidth) /
                    ratioX;
                maxHeight =
                    (chartArea.bottom - chartArea.top - chart.borderWidth) /
                    ratioY;
                chart.outerRadius = Math.max(
                    Math.min(maxWidth, maxHeight) / 2,
                    0
                );
        ...
        var core_interaction = {
            ...
            modes: {
                ...
                dataset: function (chart, e, options) {
                    ...
                    if (items.length > 0) {
                        items = chart.getDatasetMeta(
                            items[0]._datasetIndex
                        ).data;
                    }
        ...
        var core_layouts = {
            ...
            update: function (chart, width, height) {
                ...
                var padding = helpers$1.options.toPadding(
        ...
        function createTooltipItem(element) {
            ...
            var controller =
                element._chart.getDatasetMeta(datasetIndex).controller;
        ...
        helpers$1.extend(
            ...
            /** @lends Chart */ {
                ...
                buildOrUpdateScales: function () {
                    ...
                    var items = [];
                    var updated = Object.keys(scales).reduce(function (
                        obj,
                        id
                    ) {
                        obj[id] = false;
                    ...
                    helpers$1.each(items, function (item) {
                        ...
                        if (id in scales && scales[id].type === scaleType) {
                            ...
                            var scaleClass =
                                core_scaleService.getScaleConstructor(
                                    scaleType
                                );
                            if (!scaleClass) {
                                return;
                ...
                updateDatasets: function () {
                    ...
                    if (
                        core_plugins.notify(me, "beforeDatasetsUpdate") ===
                        false
                    ) {
                        return;
                    }
                ...
                updateDataset: function (index) {
                    ...
                    if (
                        core_plugins.notify(me, "beforeDatasetUpdate", [
                            args,
                        ]) === false
                    ) {
                        return;
                ...
                updateHoverStyle: function (elements, mode, enabled) {
                    ...
                    for (i = 0, ilen = elements.length; i < ilen; ++i) {
                        ...
                        if (element) {
                            this.getDatasetMeta(
                                element._datasetIndex
                            ).controller[prefix + "HoverStyle"](element);
                        }
                    }

                    if (mode === "dataset") {
                        this.getDatasetMeta(
                            elements[0]._datasetIndex
                        ).controller["_" + prefix + "DatasetHoverStyle"]();
                    }
                },
        ...
        var core_helpers = function () {
            ...
            helpers$1.splineCurveMonotone = function (points) {
                ...
                for (i = 0; i < pointsLen; ++i) {
                    ...
                    if (pointBefore && !pointBefore.model.skip) {
                        deltaX =
                            (pointCurrent.model.x - pointBefore.model.x) / 3;
                    ...
                    if (pointAfter && !pointAfter.model.skip) {
                        deltaX =
                            (pointAfter.model.x - pointCurrent.model.x) / 3;
                ...
                linear: function (tickValue, index, ticks) {
                    ...
                    if (tickValue !== 0) {
                        ...
                        if (maxTick < 1e-4) {
                            ...
                            tickString =
                                tickValue.toExponential(numExponential);
                        } else {
        ...
        var Scale = core_element.extend({
                ...
                if (maxLabelWidth + 6 > tickWidth) {
                    ...
                    labelRotation = helpers$1.toDegrees(
                        Math.min(
                            ...
                            Math.asin(
                                Math.min(maxHeight / maxLabelDiagonal, 1)
            ...
            fit: function () {
                ...
                if (tickOpts.display && display) {
                    ...
                    if (isHorizontal) {
                        ...
                        var angleRadians = helpers$1.toRadians(
                            me.labelRotation
                        );
                        ...
                        var offsetRight =
                            me.right -
                            me.getPixelForTick(me.getTicks().length - 1);
                        ...
                        if (isRotated) {
                            paddingLeft = isBottom
                                ...
                                : sinRotation *
                                  (firstLabelSize.height -
                                      firstLabelSize.offset);
            ...
            _drawLabels: function () {
                ...
                var items =
                    me._labelItems ||
                    (me._labelItems = me._computeLabelItems());
        ...
        function generateTicks(generationOptions, dataRange) {
            ...
            if (numSpaces > maxNumSpaces) {
                ...
                spacing =
                    helpers$1.niceNum(
                        (numSpaces * spacing) / maxNumSpaces / unit
                    ) * unit;
            }
        ...
        function nonNegativeOrDefault(value, defaultValue) {
            return helpers$1.isFinite(value) && value >= 0
                ? value
                : defaultValue;
        }
        ...
        function fitWithPointLabels(scale) {
            ...
            var plFont = helpers$1.options._parseFont(
                scale.options.pointLabels
            );
        ...
        function drawRadiusLine(scale, gridLineOpts, radius, index) {
            ...
            var valueCount = scale.chart.data.labels.length;
            var lineColor = valueAtIndexOrDefault$1(
                gridLineOpts.color,
                index - 1
            );
        ...
        var scale_radialLinear = scale_linearbase.extend({
            ...
            setReductions: function (
                ...
                var radiusReductionBottom =
                    -Math.max(
                        furthestLimits.b - (me.height - me.paddingTop),
                        0
        ...
        function getMin(options) {
            return helpers$1.valueOrDefault(
                options.time.min,
                options.ticks.min
            );
        }
        ...
        function determineUnitForAutoTicks(minUnit, min, max, capacity) {
            ...
            for (i = UNITS.indexOf(minUnit); i < ilen - 1; ++i) {
                ...
                if (
                    interval.common &&
                    Math.ceil((max - min) / (factor * interval.size)) <=
                        capacity
                ) {
                    return UNITS[i];
                }
        ...
        var scale_time = core_scale.extend({
            ...
            convertTicksToLabels: function (ticks) {
                ...
                for (i = 0, ilen = ticks.length; i < ilen; ++i) {
                    labels.push(
                        this.tickFormatFunction(ticks[i].value, i, ticks)
                    );
                }
        ...
        function drawArea(ctx, curve0, curve1, len0, len1) {
            ...
            if (curve1[0].angle !== undefined) {
                ...
                cy = curve1[0].cy;
                r = Math.sqrt(
                    Math.pow(curve1[0].x - cx, 2) +
                        Math.pow(curve1[0].y - cy, 2)
                );
                for (i = len1 - 1; i > 0; --i) {
                    ctx.arc(
                        cx,
            ...
            draw: function () {
                ...
                var alignmentOffset = function (dimension, blockSize) {
                    switch (opts.align) {
                        ...
                        default:
                            // center
                            return (
                                (dimension - blockSize + labelOpts.padding) / 2
                            );
                    }
                };
                ...
                if (isHorizontal) {
                    cursor = {
                        x:
                            me.left +
                            alignmentOffset(legendWidth, lineWidths[0]),
        ...
        var Title = core_element.extend({
            ...
            fit: function () {
                ...
                me.width = minSize.width = isHorizontal
                    ? me.maxWidth
                    : textSize;
                me.height = minSize.height = isHorizontal
                    ? textSize
                    : me.maxHeight;
            },
            afterFit: noop$2,
                ...
                core_controller[klass] = function (ctx, cfg) {
                    return new core_controller(
                        ...
                        core_controller.helpers.merge(cfg || {}, {
                            type:
                                klass.charAt(0).toLowerCase() + klass.slice(1),
                        })
                    );
                };
            }
    ...
    function customTooltips(tooltipModel) {
        ...
        if (tooltipModel.body) {
            ...
            tooltipBodyItems.forEach(function (item, i) {
                ...
                var tooltipBodyItemColor = document.createElement(
                    Selector.SPAN
                );
                tooltipBodyItemColor.className =
                    ClassName.TOOLTIP_BODY_ITEM_COLOR;
                tooltipBodyItemColor.style.backgroundColor =
                    colors.backgroundColor;
                tooltipBodyItem.appendChild(tooltipBodyItemColor);

                if (item[0].split(":").length > 1) {
                    var tooltipBodyItemLabel = document.createElement(
                        Selector.SPAN
                    );
                    ...
                    var tooltipBodyItemValue = document.createElement(
                        Selector.SPAN
                    );
                    ...
                    var _tooltipBodyItemValue = document.createElement(
                        Selector.SPAN
                    );

                    _tooltipBodyItemValue.className =
                        ClassName.TOOLTIP_BODY_ITEM_VALUE;
