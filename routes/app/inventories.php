...
Route::prefix('inventories')->group(function () {
    ...
    Route::middleware('plan.feature:'.FeatureEnum::INVENTORY_MANAGEMENT->value)
        ...
        ->group(function () {
            ...
            Route::middleware('plan.feature:'.FeatureEnum::STOCK_MOVEMENTS->value)->group(function () {
    ...
    Route::middleware('plan.feature:'.FeatureEnum::INVENTORY_MANAGEMENT->value)
        ->name('inventory.')->group(function () {
            ...
            // Suppliers
            Route::middleware('plan.feature:'.FeatureEnum::SUPPLIER_MANAGEMENT->value)->group(function () {
            ...
            // Stock Opnames
            Route::middleware('plan.feature:'.FeatureEnum::STOCK_OPNAME->value)->group(function () {
            ...
            // Adjustments
            Route::middleware('plan.feature:'.FeatureEnum::STOCK_ADJUSTMENTS->value)->group(function () {
            ...
            // Transfers
            Route::middleware('plan.feature:'.FeatureEnum::STOCK_TRANSFERS->value)->group(function () {
