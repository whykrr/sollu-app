...
use App\Http\Requests\App\Reports\GetPromotionReportRequest;
...
{
    public function index(GetPromotionReportRequest $request, PromotionReportService $service): Response
    {
    ...
    public function exportPdf(ExportReportRequest $request): RedirectResponse
    {
        ...
        ExportPromotionReportPdfJob::dispatch($user, $outletIds, $startDate, $endDate);
    ...
    public function exportCsv(ExportReportRequest $request): RedirectResponse
    {
        ...
        ExportPromotionReportJob::dispatch($user, $outletIds, $startDate, $endDate);
