...
class ProductCategoryController extends Controller
{
    ...
    public function store(StoreProductCategoryRequest $request)
    {
        ...
        return redirect()->route('products.categories.index')->with('success', 'Kategori produk berhasil ditambahkan.');
    }
    ...
    public function update(UpdateProductCategoryRequest $request, ProductCategory $category)
    {
        ...
        return redirect()->route('products.categories.index')->with('success', 'Kategori produk berhasil diperbarui.');
    }
    ...
    public function destroy(ProductCategory $category)
    {
        ...
        return redirect()->route('products.categories.index')->with('success', 'Kategori produk berhasil dihapus (soft delete).');
    }
    ...
    public function forceDelete(ProductCategory $category)
    {
        ...
        return redirect()->route('products.categories.index')->with('success', 'Kategori produk berhasil dihapus permanen.');
    }
}
