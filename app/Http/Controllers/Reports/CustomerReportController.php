...
class CustomerReportController extends Controller
{
    ...
    public function exportPdf(Request $request)
    {
        ...
        \App\Jobs\Reports\Pdf\ExportCustomerReportPdfJob::dispatch(\Illuminate\Support\Facades\Auth::user(), (array) $outletId, $startDate, $endDate);
    ...
    public function exportCsv(Request $request)
    {
        ...
        ExportCustomerReportJob::dispatch(Auth::user(), (array) $outletId, $startDate, $endDate);
