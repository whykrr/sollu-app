...
class WelcomeUser extends BaseNotification
{
    ...
    public function __construct()
    {
        ...
        $this->title = 'Selamat Datang di Sollu App!';
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Akun Anda saat ini berada dalam masa percobaan gratis 15 hari. Nikmati semua fitur tanpa batasan untuk merasakan manfaat maksimal dari Sollu.')
