...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb my-0 ms-2">
        ...
        <li class="breadcrumb-item"><span>Stok</span></li>
        <li class="breadcrumb-item active"><span>Tambah Stok Manual</span></li>
    </ol>
</nav>
    ...
    <div class="fade-in">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Form Tambah Stok Manual</h5>
            </div>
            <?php
            $invoiceCode = 'INV-SP-' . rand(101, 999) . date('his') . '-' . date('dmy');
            ?>
            <div class="card-body">
                <form class="row ajax" action="<?php echo base_url('inventory/stock/store'); ?>" data-respond="redirect" data-redirect="<?= base_url('inventory/stock') ?>">
                    <div class="col-md-6">
                        <!-- <div class="form-group">
                            <label for="code">Nomor Invoice</label>
                            <input type="text" name="invoice_no" class="form-control" id="code" placeholder="">
                            <input type="hidden" name="invoice_no_generate" value="">
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            <div class="card-header p-2">
                                <h5 class="card-title mb-0"><strong>List Stok</strong></h5>
                            </div>
                    ...
                    <div class="col-md-2 pr-0">
                        <a href="<?= base_url('inventory/stock') ?>" class="btn btn-danger btn-block">
