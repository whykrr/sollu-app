...
<div class="container-fluid">
    <div class="fade-in">
        <div class="card">
            ...
            <div class="card-body">
                <button class="btn btn-success mb-2 float-right" data-toggle="modal" data-target="#modalSide" data-page="masterdata/product_category/form">
                    <div class="c-icon mr-1 cil-plus"></div>
                    <span>Tambah Data</span>
                </button>
                <div class="table-responsive">
                    <?= loadDatatables("product_category") ?>
                </div>
            </div>
        </div>
    </div>
