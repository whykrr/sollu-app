...
5. **Tetap Profesional & Jelas (*Clarity First*):** Jangan menggunakan kata gaul/slang berlebihan yang menurunkan kredibilitas (*hindari: "bgt", "gak jelas", "gokil", "mantap gan"*). Istilah bisnis baku (*SKU, Stok Opname, Resep, HPP, Void, Refund, Outlet*) tetap digunakan secara presisi.
